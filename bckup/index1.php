...
<ul>
  <li class="active">
    ...
    <form action="config/sale.php" method="get" enctype="multiple/form-data">
     <li class="active"><a href='config/sale.php'  type="submit" name="land" role="button"><span>Land</span></a></b></li>
   </form>


     <form action="config/aprt.php" method="get" enctype="multipart/form-data">
   <li class="active"><a href='config/aprt.php' name="appartments" role="button"><span>Apartments</span></a></li>
 </form>

<form action="post.php" method="search" enctype="multipart/form-data">
   <li class="active"><a href='post.php'><span>Post</span></a></li></form>
   <form action="post.php" method="search" enctype="multipart/form-data">
   <li class='active'><a href="login.php" role="button"><span>Login</span></a></li></form>
